...
{
public:
    static std::shared_ptr<GModel> CreateModelGObj(GModelType modelType, std::string modelPath="", bool init_texture=true);
    GModel(GModelType modelType);

    virtual bool hit(const GMath::GRay& ray, GMath::interval intervalV, GMath::GHitInfo& hitInfo)
    {
        return false;
    }
